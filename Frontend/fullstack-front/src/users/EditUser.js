            ...
            <div className='col-md-6 offset-md-3 border rounded p-4 mt-2 shadow'>
                ...
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className='mb-3'>
                        ...
                        <input type={"text"} className='form-control' placeholder='Enter your username' name='username' value={username} required
                            onChange={(e) => onInputChange(e)} />
                    </div>
                    <div className='mb-3'>
                        <label htmlFor='Name' className='form-label'>
                        ...
                        <input type={"email"} className='form-control' placeholder='Enter your e-mail address' name='email' value={email} required
                            onChange={(e) => onInputChange(e)} />
                    </div>
